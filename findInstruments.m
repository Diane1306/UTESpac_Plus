...
if isfield(sensorInfo,'u')
    ...
    for ii = 1:numSonics
        ...
        if info.sonicManufact(ii)==1 % modified by Diane to add one more type of sonic
            manufact = 'Campbell';
        elseif info.sonicManufact(ii)==0
            manufact = 'RMYoung ';
        elseif info.sonicManufact(ii)==2
            manufact = 'Gill WindmasterPro';
        end
